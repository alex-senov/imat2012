...
nnet <- nnet(x=data[,usingFeatures], y=y, size=200, MaxNWts=3000, decay=0.001)
...
sessionOrder <- outData[order(predict,decreasing=TRUE), 1]
setwd("D:/Интернет-математика 2012/result")
>>>>>>> 834a03ee031a9e2d6009e3e46b0f5f50dee5a53a:Code/NeuralNetwork.R
